...
def generate_pam_mail():
    ...
    mail = (
        Email('pam.beesly@dundermifflin.com', 'jim.halpert@dundermifflin.com', 'lets prank Dwight', 1),
        Email('jim.halpert@dundermifflin.com', 'pam.beesly@dundermifflin.com', 'im in', 0)
    )
...
def generate_dwight_mail():
    ...
    mail = (
        Email('dwight.shrute@dundermifflin.com', 'michael.scott@dundermifflin.com', 'knock, knock ...', 2),
        Email('michael.scott@dundermifflin.com', 'dwight.shrute@dundermifflin.com', 'who\'s there?', 1),
        Email('dwight.shrute@dundermifflin.com', 'michael.scott@dundermifflin.com', 'the KGB', 1),
        Email('michael.scott@dundermifflin.com', 'dwight.shrute@dundermifflin.com', 'the KGB who?', 1),
        Email('dwight.shrute@dundermifflin.com', 'michael.scott@dundermifflin.com', 'nobody questions the KGB!', 0)
    )
...
def generate_michael_mail():
    ...
    mail = (
        Email('michael.scott@dundermifflin.com', 'jim.halpert@dundermifflin.com', 'I declare bankruptcy!', 0),
    )
